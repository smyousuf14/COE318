...
public class Resistor {
    ...
    private double  resistanceActual;
    private double currentActual;
    private double voltageActual;
    ...
    public void setVoltage(double voltage) {
        ...
        voltageActual = voltage;
        
        /*Adjust the current accordingly. As the resistance will always stay the same*/
        currentActual = voltageActual / resistanceActual;
    }
    ...
    public void setCurrent(double current) {
        ...
        /*Make sure the adjust voltage accordingly*/
        voltageActual = currentActual * resistanceActual;
    }
